...
export default function FirstPage(){
    return (
        <div className="w-full min-h-screen grid grid-cols-10 gap-5">
            <div className="bg-gray-primary w-full rounded-t-3xl rounded-bl-3xl col-span-3  h-full  ">
                <div className="bg-gray-primary w-full rounded-t-3xl rounded-bl-3xl  xl col-span-3 p-5 h-full flex flex-col ">
            ...
            <div className=" w-full h-full col-span-7 rounded-3xl">
