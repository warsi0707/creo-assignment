...
export default function hambergMenu({setHambergMenu}){
    return (
        <div onClick={()=> setHambergMenu(false)} className="bg-black/70 min-h-screen w-full fixed top-0 left-0">
            <div onClick={(e)=> e.stopPropagation()} className="bg-white w-1/3  h-full absolute p-3">
